...
enum eCreatures
{
    ...
    MOB_ADVANCE_SCOUT_CHADWICK     = 55138
};
    ...
    public:
        ...
        struct boss_warchief_kargath_bladefistAI : public ScriptedAI
        {
            ...
            void JustDied(Unit* killer)
            {
                ...
                if (killer->GetTypeId() == TYPEID_PLAYER && killer->ToPlayer()->GetOTeam() == ALLIANCE)
                    me->SummonCreature(MOB_ADVANCE_SCOUT_CHADWICK, 242.887f, -83.754f, 4.9386f, 3.1519f);
            }
