...
#define GOSSIP_FIDELIO          "Fly me to Darnassus!"
#define GOSSIP_BRAGOK           "I need a flight to Dustwallow Marsh."
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        case 17209:
            ...
            break;
        case 40553: // Dolanaar - Fidelio
            if (player->GetQuestStatus(6341) == QUEST_STATUS_COMPLETE)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_FIDELIO, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 31);
            break;
        case 16227: // Ratchet - Bragok
            if (player->GetQuestStatus(26702) == QUEST_STATUS_COMPLETE)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_BRAGOK, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 32);
            break;
        }
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 31:
            player->CLOSE_GOSSIP_MENU();
            player->ActivateTaxiPathTo(1988, 0, true);
            break;
        case GOSSIP_ACTION_INFO_DEF + 32:
            player->CLOSE_GOSSIP_MENU();
            player->ActivateTaxiPathTo(460, 0, true);
            break;
        }
