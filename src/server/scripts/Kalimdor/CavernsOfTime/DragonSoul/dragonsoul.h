...
Position const skyCaptainPos = {-1695.379395f, -2358.080566f, 339.437836f, 4.750f};
Position const kanuReevsPos = {-1692.427368f, -2358.080566f, 339.437836f, 4.750f};
