...
const float GUNSHIP_POS_X = -1699.573853f;
const float GUNSHIP_POS_Y = -2374.943848f;
const float GUNSHIP_POS_Z = 319.0f;
const float GUNSHIP_POS_O = 1.666860f;
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_OUTRO_START_CINEMATIC:
                {
                    ...
                    me->SummonCreature(NPC_KANU_REEVS, kanuReevsPos);
