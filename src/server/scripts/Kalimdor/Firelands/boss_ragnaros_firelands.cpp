...
enum Spells
{
    ...
    SPELL_LIVING_METEOR_COMBUSTIBLE_25      = 100282,
    SPELL_LIVING_METEOR_COMBUSTIBLE_10H     = 100283,
    SPELL_LIVING_METEOR_COMBUSTIBLE_25H     = 100284,
    ...
    SPELL_LIVING_METEOR_EXPLOSION_TRIGGER_25 = 100279,
    SPELL_LIVING_METEOR_EXPLOSION_TRIGGER_10H = 100280,
    SPELL_LIVING_METEOR_EXPLOSION_TRIGGER_25H = 100281,
    SPELL_LIVING_METEOR_INCREASE_SPEED      = 100278,
    SPELL_LIVING_METEOR_INCREASE_SPEED_25   = 100285,
    SPELL_LIVING_METEOR_SPEED_TRIGGERED     = 100277,
    SPELL_LIVING_METEOR_SPEED_TRIGGERED_25  = 100286,
...
class npc_fl_living_meteor : public CreatureScript
{
    public:
        ...
        struct npc_fl_living_meteorAI : public ScriptedAI
        {
            ...
            {
                if (target->GetEntry() == NPC_BREADTH_OF_FROST && spellInfo->Id == SPELL_BREADTH_OF_FROST_STUN)
                {
                    target->ToCreature()->DespawnOrUnsummon();
                    me->StopMoving();
                    me->GetMotionMaster()->MovementExpired(false);
                    me->RemoveAura(SPELL_LIVING_METEOR_DAMAGE_REDUCTION);
                    me->RemoveAura(RAID_MODE(SPELL_LIVING_METEOR_COMBUSTIBLE, SPELL_LIVING_METEOR_COMBUSTIBLE_25, SPELL_LIVING_METEOR_COMBUSTIBLE_10H, SPELL_LIVING_METEOR_COMBUSTIBLE_25H));
                    me->RemoveAura(RAID_MODE(SPELL_LIVING_METEOR_INCREASE_SPEED, SPELL_LIVING_METEOR_INCREASE_SPEED_25));
                    me->RemoveAura(RAID_MODE(SPELL_LIVING_METEOR_SPEED_TRIGGERED, SPELL_LIVING_METEOR_SPEED_TRIGGERED_25));
                    me->RemoveAura(RAID_MODE(SPELL_LIVING_METEOR_EXPLOSION_TRIGGER, SPELL_LIVING_METEOR_EXPLOSION_TRIGGER_25, SPELL_LIVING_METEOR_EXPLOSION_TRIGGER_10H, SPELL_LIVING_METEOR_EXPLOSION_TRIGGER_25H));
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_CONTINUE_METEOR:
                            DoCast(me, SPELL_LIVING_METEOR_DAMAGE_REDUCTION, true);
                            DoCast(me, SPELL_LIVING_METEOR_EXPLOSION_TRIGGER, true);
                            DoCast(me, SPELL_LIVING_METEOR_COMBUSTIBLE, true);
                            events.ScheduleEvent(EVENT_STALK_PLAYER, 2000);
                        default:
                            break;
                    }
                }
