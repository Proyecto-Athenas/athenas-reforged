...
public:
    ...
    struct boss_anshalAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* killer)
        {
            ...
            me->NearTeleportTo(home.GetPositionX()+8.0f, home.GetPositionY(), home.GetPositionZ(), home.GetOrientation());
        }
    ...
    struct npc_slipstream_alakirAI : public PassiveAI
    {
        ...
        void PassengerBoarded(Unit* who, int8 seatId, bool apply)
        {
            if (apply)
            {
                ...
                if (Creature* aolajier = me->FindNearestCreature(46753, 500.0f, true))
                {
                    if (!aolajier || aolajier->isDead())
                        who->AddAura(82724, who);
                }
                else
                    who->AddAura(82724, who);
            }
