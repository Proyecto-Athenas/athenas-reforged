...
{
    { GO_HIGH_INQUISITORS_DOOR, DATA_MOGRAINE_AND_WHITE_EVENT, DOOR_TYPE_SPAWN_HOLE, BOUNDARY_NONE },
            ...
            void OnCreatureCreate(Creature* creature) override
            {
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_VORREL:
                        ...
                        break;
                    case NPC_HORSEMAN_HUMAN:
                        HorsOutroGUID = creature->GetGUID();
                ...
                switch (type)
                {
                    case DATA_HORSEMAN_EVENT:
                        if (state == DONE)
                        {
                            ...
                            HorsemanAdds.clear();
                            HandleGameObject(PumpkinShrineGUID, false);
                            if (Creature *hs = instance->GetCreature(HorsOutroGUID))
                                hs->SetVisible(true);
                        }
                        break;
                    default:
