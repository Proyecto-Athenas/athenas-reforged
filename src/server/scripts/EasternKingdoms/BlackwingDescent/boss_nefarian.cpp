...
class boss_bwd_onyxia : public CreatureScript
{
    struct boss_bwd_onyxiaAI : public BossAI
    {
        ...
        void DoAction(const int32 act)
        {
            ...
            case ACTION_INTRO: {
                me->SetVisible(true);
                if (chain[0] = me->SummonCreature(NPC_INVISIBLE_STALKER_CATACLYSM_BOSS, -141.3331f, -224.6247f,
                                                  8.380039f, 0.0f))
                {
                ...
                if (chain[1] = me->SummonCreature(NPC_INVISIBLE_STALKER_CATACLYSM_BOSS, -90.35625f, -253.4714f,
                                                  8.380039f, 0.0f))
                {
                ...
                if (chain[2] = me->SummonCreature(NPC_INVISIBLE_STALKER_CATACLYSM_BOSS, -90.22045f, -195.6071f,
                                                  8.380039f, 0.0f))
                {
        ...
        bool Execute(uint64 execTime, uint32 /*diff*/)
        {
            if (Creature* c = _owner->ToCreature())
            {
                ...
                else
                {
                    ...
                    // if (Player *player = c->FindNearestPlayer(500.0f)) grid are not correctly update when players are
                    // on transport...
                    if (player)
                    {
        ...
        bool Execute(uint64 execTime, uint32 /*diff*/)
        {
            ...
            else if (_owner->ToCreature())
            {
                ...
                _owner->m_Events.AddEvent(
                    new CheckReactState(_owner),
                    _owner->m_Events.CalculateTime(_owner->GetMap()->Is25ManRaid() ? 6000 : 12000));
            }
            return false;
        }
    ...
    struct boss_bwd_nefarianAI : public BossAI
    {
        ...
        void JustSummoned(Creature* summon)
        {
            ...
            case NPC_SHADOWBLAZE_FLASHPOINT:
                ...
                summon->m_Events.AddEvent(new BrushFireEvent(summon, _currentPhase),
                                          summon->m_Events.CalculateTime(1000));
                break;
        ...
        void DamageTaken(Unit* caster, uint32& damage)
        {
            if ((!HealthAbovePct(90) && electrocuteCount == 0) || (!HealthAbovePct(80) && electrocuteCount == 1) ||
                (!HealthAbovePct(70) && electrocuteCount == 2) || (!HealthAbovePct(60) && electrocuteCount == 3) ||
                (!HealthAbovePct(50) && electrocuteCount == 4) || (!HealthAbovePct(40) && electrocuteCount == 5) ||
                (!HealthAbovePct(30) && electrocuteCount == 6) || (!HealthAbovePct(20) && electrocuteCount == 7) ||
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_NEFARIAN_ELECTROCUTE:
                    ...
                    if (Creature* nefarianLightingMachine =
                            me->FindNearestCreature(NPC_NEFARIAN_LIGHTING_MACHINE, 1000.0f))
                        nefarianLightingMachine->CastSpell(nefarianLightingMachine, SPELL_NEFARIAN_ELECTROCUTE_DUMMY,
                                                           true);
                    break;
                ...
                case EVENT_NEFARIAN_BRUSHFIRE_SUMMON:
                    ...
                    me->CastCustomSpell(SPELL_NEFARIAN_OMBREFLAME, SPELLVALUE_MAX_TARGETS, RAID_MODE(4, 10, 4, 10), me,
                                        true);
...
class npc_animated_bone_warrior : public CreatureScript
{
  public:
    ...
    {
        npc_animated_bone_warriorAI(Creature* creature) : ScriptedAI(creature), _instance(creature->GetInstanceScript())
        {
        }
...
class spell_onyxia_eletric_charge_periodic_dummy : public SpellScriptLoader
{
  public:
    ...
    class spell_onyxia_eletric_charge_periodic_dummy_AuraScript : public AuraScript
    {
        ...
        {
            OnEffectPeriodic +=
                AuraEffectPeriodicFn(spell_onyxia_eletric_charge_periodic_dummy_AuraScript::HandleEffectPeriodic,
...
{
  public:
    spell_onyxia_deathwing_children_periodic_dummy()
        : SpellScriptLoader("spell_onyxia_deathwing_children_periodic_dummy")
    {
    }
    ...
    class spell_onyxia_deathwing_children_periodic_dummy_AuraScript : public AuraScript
    {
        ...
        {
            OnEffectPeriodic +=
                AuraEffectPeriodicFn(spell_onyxia_deathwing_children_periodic_dummy_AuraScript::HandleEffectPeriodic,
                                     EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
...
{
  public:
    spell_nefarian_deathwing_children_periodic_dummy()
        : SpellScriptLoader("spell_nefarian_deathwing_children_periodic_dummy")
    {
    }
    ...
    class spell_nefarian_deathwing_children_periodic_dummy_AuraScript : public AuraScript
    {
        ...
        {
            OnEffectPeriodic +=
                AuraEffectPeriodicFn(spell_nefarian_deathwing_children_periodic_dummy_AuraScript::HandleEffectPeriodic,
                                     EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
...
class spell_nefarian_eletric_charge_periodic_dummy : public SpellScriptLoader
{
  public:
    ...
    class spell_nefarian_eletric_charge_periodic_dummy_AuraScript : public AuraScript
    {
        ...
        {
            OnEffectPeriodic +=
                AuraEffectPeriodicFn(spell_nefarian_eletric_charge_periodic_dummy_AuraScript::HandleEffectPeriodic,
                                     EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
...
class spell_nefarian_shadow_of_cowardice_dummy : public SpellScriptLoader
{
  public:
    ...
    class spell_nefarian_shadow_of_cowardice_dummy_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_nefarian_shadow_of_cowardice_dummy_SpellScript::HandleDummy,
...
class spell_nefarian_dominion_dummy : public SpellScriptLoader
{
  public:
    ...
    class spell_nefarian_dominion_dummy_SpellScript : public SpellScript
    {
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_nefarian_dominion_dummy_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
...
{
  public:
    spell_onyxia_nefarian_shadowflame_breath_dummy()
        : SpellScriptLoader("spell_onyxia_nefarian_shadowflame_breath_dummy")
    {
    }
    ...
    class spell_onyxia_nefarian_shadowflame_breath_dummy_SpellScript : public SpellScript
    {
        ...
        {
            // Also resurrects Animated Bone Warriors in the area of effect. from
            // http://www.wowwiki.com/Nefarian_%28Blackwing_Descent_tactics%29
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_onyxia_nefarian_shadowflame_breath_dummy_SpellScript::HandleScriptEffect, EFFECT_2,
    ...
    class spell_onyxia_nefarian_tail_slash_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_onyxia_nefarian_tail_slash_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_ENEMY_104);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_onyxia_nefarian_tail_slash_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_CONE_ENEMY_104);
        }
    };
...
class spell_nefarian_electrocute_dummy : public SpellScriptLoader
{
  public:
    ...
    class spell_nefarian_electrocute_dummy_SpellScript : public SpellScript
    {
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_nefarian_electrocute_dummy_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_nefarian_electrocute_dummy_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
        }
    };
...
class LightingDischargeTargetSelector
{
  ...
  public:
    ...
    {
        return _me->isInFrontInMap(target->ToUnit(), 60.0f, static_cast<float>(M_PI / 5)) ||
               _me->isInBackInMap(target->ToUnit(), 60.0f, static_cast<float>(M_PI / 5));
    }
...
class spell_lighting_discharge_damage : public SpellScriptLoader
{
    class spell_lighting_discharge_damage_SpellScript : public SpellScript
    {
        ...
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_lighting_discharge_damage_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnEffectHitTarget += SpellEffectFn(spell_lighting_discharge_damage_SpellScript::HandleEffect, EFFECT_0,
...
class npc_nefarius_nefarian_intro : public CreatureScript
{
  public:
    ...
    {
        npc_nefarius_nefarian_introAI(Creature* creature)
            : ScriptedAI(creature), _instance(creature->GetInstanceScript())
        {
        }
        ...
        void UpdateAI(uint32 const diff)
        {
            ...
            while (uint32 eventId = _events.ExecuteEvent())
            {
                ...
                case EVENT_START_INTRO:
                    me->SummonCreature(BOSS_NEFARIAN, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(),
                                       me->GetOrientation());
    ...
    bool OnGossipHello(Player* player, GameObject* go)
    {
        ...
        if (InstanceScript* instance = go->GetInstanceScript())
        {
            ...
            if (instance->instance->IsHeroic() &&
                (!instance->IsDoneInHeroic(DATA_MAGMAW) || !instance->IsDoneInHeroic(DATA_OMNOTRON_DEFENSE_SYSTEM) ||
                 !instance->IsDoneInHeroic(DATA_MALORIAK) || !instance->IsDoneInHeroic(DATA_ATRAMEDES) ||
                 !instance->IsDoneInHeroic(DATA_CHIMAERON)))
                return false;

            if (Creature* nefarius = go->FindNearestCreature(NPC_NEFARIUS_INTRO, 200, true))
            {
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_DRAGON_ORB, GOSSIP_SENDER_MAIN,
        ...
        void CalculateAmount(AuraEffect const* aurEff, int32& amount, bool& canBeRecalculated)
        {
            ...
            if (Unit* caster = GetCaster())
            {
                ...
                if (Aura* magmaStack = caster->GetAura(spellId, caster->GetGUID()))
                    amount =
                        5000 + magmaStack->GetStackAmount() * magmaStack->GetSpellInfo()->Effects[EFFECT_0].BasePoints;
            }
        }

        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_nefarian_magma_damage_AuraScript::CalculateAmount,
                                                         EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_nefarian_magma_damage_AuraScript::onPeriodicTick, EFFECT_0,
...
class spell_nefarian_ombrase : public SpellScriptLoader
{
  public:
    ...
    class spell_nefarian_ombrase_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_nefarian_ombrase_SpellScript::HandleScriptEffect, EFFECT_1,
                                               SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
  ...
  public:
    ...
    class spell_nefarian_ombrase_P2_SpellScript : public SpellScript
    {
      ...
      private:
        ...
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_nefarian_ombrase_P2_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
  ...
  public:
    ...
    struct npc_dominion_tracker_summonAI : public ScriptedAI
    {
        ...
        void IsSummonedBy(Unit* player)
        {
            ...
            player->GetMotionMaster()->ForceMovePoint(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 1.2f,
                                                      0, false);
    ...
    class spell_nefarian_mind_free_AuraScript : public AuraScript
    {
        ...
        void Remove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            if (Unit* target = GetTarget())
            {
                ...
                for (std::list<Creature*>::iterator itr = dominions_trackers.begin(); itr != dominions_trackers.end();
                     itr++)
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectRemoveFn(spell_nefarian_mind_free_AuraScript::Remove, EFFECT_0,
...
class spell_nefarian_absorb_power_dummy : public SpellScriptLoader
{
  public:
    ...
    class spell_nefarian_absorb_power_dummy_SpellScript : public SpellScript
    {
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_nefarian_absorb_power_dummy_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
    ...
    class spell_nefarian_explosive_cinder_AuraScript : public AuraScript
    {
        ...
        void Remove(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
        {
            if (Unit* target = GetTarget())
            {
                ...
                // can get rid of the Explosive Cinders without any negative effects (ie. it will not knock back players
                // on your platform).
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectRemoveFn(spell_nefarian_explosive_cinder_AuraScript::Remove, EFFECT_0,
