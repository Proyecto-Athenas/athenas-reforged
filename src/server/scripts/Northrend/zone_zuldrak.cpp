...
void DespawnOthers(uint32 const& entry, Unit const* me)
{
    ...
    for (auto &unit : targets)
    {
        ...
        if (!creature || !creature->IsInWorld() || creature->GetEntry() != entry)
            continue;

        creature->DespawnOrUnsummon(35 * IN_MILLISECONDS);
    }
}
...
enum eGurgthock
{
    ...
    QUEST_AMPHITHEATER_CHAMPION_OF_ANGUISH = 12948,
                ...
                case 1:
                    switch (uiValue)
                    {
                        ...
                        case QUEST_AMPHITHEATER_ANGUISH_FROM_BEYOND:
                            ...
                            uiPhase = 12;
                            break;
                        case QUEST_AMPHITHEATER_CHAMPION_OF_ANGUISH:
                            uiTimer = 2000;
                            uiPhase = 30;
                            break;
                   }
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            if (uiPhase)
            {
                ...
                if (uiTimer <= uiDiff)
                {
                    ...
                    {
                        case 1:
                            DespawnOthers(NPC_ORINOKO_TUSKBREAKER, me);
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            DespawnOthers(NPC_KORRAK_BLOODRAGER, me);
                        ...
                        case 14:
                            ...
                            DespawnOthers(Boss[uiBossRandom].uiBoss, me);
                            ...
                            break;
                        case 30:
                            DespawnOthers(NPC_VLADOF_THE_BUTCHER, me);
                            if (Creature* creature = me->SummonCreature(NPC_VLADOF_THE_BUTCHER, SpawnPosition[0], TEMPSUMMON_CORPSE_DESPAWN, 1000))
                                creature->GetMotionMaster()->MovePoint(5775.85f, -2983.59f, 272.98f, true);
                            uiTimer = 100000;
                            uiPhase = 0;
                            break;
                    }
...
public:
    ...
    struct npc_korrak_bloodragerAI : public npc_escortAI
    {
        ...
        void Reset()
        {
            ...
            bEnrage = false;
            me->GetMotionMaster()->MovePoint(6, 5775.85f, -2983.59f, 282.98f, true);
        }
...
public:
    ...
    struct npc_stinkbeardAI : public npc_escortAI
    {
        ...
        void Reset()
        {
            ...
            bEnrage = false;
            bThunderClap = false;
            me->GetMotionMaster()->MovePoint(7, 5775.85f, -2983.59f, 272.98f, true);
        }
