    ...
    public:
        ...
        struct boss_the_lich_kingAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/) override
            {
                ...
                if (Creature* terenas = me->FindNearestCreature(NPC_TERENAS_MENETHIL_OUTRO, 100.0f, true))
    ...
    public:
        ...
        struct npc_terenas_menethilAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(Unit* /*summoner*/)
            {
                ...
                _events.ScheduleEvent(EVENT_OUTRO_TERENAS_TALK_1, 5000, 0, PHASE_OUTRO);
                _events.ScheduleEvent(EVENT_OUTRO_TERENAS_TALK_2, 17000, 0, PHASE_OUTRO);
            }
