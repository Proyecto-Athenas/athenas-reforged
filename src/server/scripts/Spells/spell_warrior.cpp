...
public:
    ...
    class spell_warr_sweeping_strikes_AuraScript : public AuraScript
    {
        ...
        bool CheckProc(ProcEventInfo &eventInfo)
        {
            ...
            return weaponCheck && _procTarget && !(eventInfo.GetSpellInfo() && eventInfo.GetSpellInfo()->Id == SPELL_WARRIOR_EXECUTE && _procTarget->GetHealthPct() >= 20) && eventInfo.GetActionTarget() != eventInfo.GetActor();
        }
