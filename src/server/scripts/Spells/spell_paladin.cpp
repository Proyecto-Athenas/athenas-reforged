...
public:
    ...
    class spell_pal_word_of_glory_SpellScript : public SpellScript
    {
        ...
        void HandleHeal(SpellEffIndex /*effIndex*/)
        {
            ...
            if (caster->ToPlayer()->GetPrimaryTalentTree(caster->ToPlayer()->GetActiveSpec()) == TALENT_TREE_PALADIN_PROTECTION)
            {
                if (overheal)
    ...
    class spell_pal_seal_of_righteousness_AuraScript : public AuraScript
    {
        ...
        void HandleProc(AuraEffect const *aurEff, ProcEventInfo &eventInfo)
        {
            ...
            if (caster->HasAura(SPELL_PALADIN_SEALS_OF_COMMAND))
            {
                ...
                caster->CastCustomSpell(SPELL_PALADIN_SEAL_OF_RIGHTEOUSNESS, SPELLVALUE_BASE_POINT0, bp, eventInfo.GetProcTarget(), true, NULL, aurEff);
        }
