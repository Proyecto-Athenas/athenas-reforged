    ...
    class spell_dk_scourge_strike_SpellScript : public SpellScript
    {
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            if (Unit *unitTarget = GetHitUnit())
            {
                ...
                SpellInfo const *shadowPart = sSpellMgr->GetSpellInfo(SPELL_DK_SCOURGE_STRIKE_TRIGGERED);
                ...
                caster->ToPlayer()->ApplySpellMod(SPELL_DK_SCOURGE_STRIKE_TRIGGERED, SPELLMOD_DAMAGE, multiplier);
            }
        }
...
void AddSC_deathknight_spell_scripts()
{
    ...
    new spell_dk_killing_machine();
    new spell_dk_t12_helper();
    new spell_dk_damcing_rune_weapon();
