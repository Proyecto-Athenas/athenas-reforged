...
MovementStatusElements const MoveUpdateSwimBackSpeed[] =
{
    MSEHasGuidByte7,
    MSEHasGuidByte2,
    MSEHasTransportData,
...
MovementStatusElements const MoveForcePitchRateChangeAck[] =
{
    MSEPositionX,
    MSECounter,
    MSESpeedPitchRate,
...
MovementStatusElements const MoveForceFlightBackSpeedChangeAck[] =
{
    MSEPositionY,
    MSEPositionZ,
    MSECounter,
...
MovementStatusElements const MoveForceTurnRateSpeedChangeAck[] =
{
    MSEPositionX,
    MSEPositionZ,
    MSESpeedTurnRate,
...
MovementStatusElements const MoveForceSwimBackSpeedChangeAck[] =
{
    MSESpeedSwimBack,
    MSEPositionX,
    MSEPositionZ,
    ...
    _unit(unit), _info(info), _BroadCastSelf(broadCastSelf), _BroadCastControlled(broadCastControlled), _isControlledPacket(true)
{
    ...
    {
        if (unit->IsSplineEnabled()) // controlled by server
            _toSend = controlled;
        else
        {
            _toSend = self;
