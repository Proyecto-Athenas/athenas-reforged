...
public:
    ...
    virtual void OnAddPassenger(Creature * /*veh*/, Unit * /*passenger*/, int8 /*seatId*/) {}
...
public:
    ...
    virtual void OnBindToInstance(Player * /*player*/, Difficulty /*difficulty*/, uint32 /*mapId*/, bool /*permanent*/, bool /*isLfg*/) {}

    // Called when a player switches to a new zone
    virtual void OnEnterMap(Player * /*player*/, uint32 /*mapId*/) {}
...
public: /* CreatureScript */
    ...
    void OnAddPassenger(Creature *veh, Unit *passenger, int8 seatId);
    void OnRemovePassenger(Creature *veh, Unit *passenger);
...
public: /* PlayerScript */
    ...
    void OnPlayerBindToInstance(Player *player, Difficulty difficulty, uint32 mapid, bool permanent, bool isLfg);
