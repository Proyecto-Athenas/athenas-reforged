...
struct AchievementCriteriaData
{
    ...
    union
    {
        ...
        // ACHIEVEMENT_CRITERIA_DATA_TYPE_S_TEAM            = 14
        struct
        {
            uint32 team;
        } team;
        ...
        // ACHIEVEMENT_CRITERIA_DATA_TYPE_T_ACRHAEOLOGY_COMPLETE_PROJECT = 22
        struct
        {
            uint32 itemQuality;
            uint32 itemQuantity;
...
class AchievementMgr
{
    public:
        ...
        void UpdateAchievementCriteria(AchievementCriteriaTypes type, uint64 miscValue1 = 0, uint64 miscValue2 = 0, uint64 miscValue3 = 0, Unit const* unit = NULL, Player* referencePlayer = NULL, GameObject* go = NULL);
        ...
        void CompletedCriteria(AchievementCriteriaEntry const* achievementCriteria, Player* referecePlayer = NULL);
    ...
    private:
        ...
        bool CanUpdateCriteria(AchievementCriteriaEntry const* criteria, AchievementEntry const* achievement, uint64 miscValue1, uint64 miscValue2, uint64 miscValue3, Unit const* unit, Player* referencePlayer, GameObject* go = NULL);
        ...
        bool RequirementsSatisfied(AchievementCriteriaEntry const* criteria, uint64 miscValue1, uint64 miscValue2, uint64 miscValue3, Unit const* unit, Player* referencePlayer, GameObject* go = NULL) const;
...
class AchievementGlobalMgr
{
    ...
    public:
        ...
        uint32 GetAchievementIdByTitleReward(uint32 title, uint32 team) const
        {
            uint32 teamIndex = team == ALLIANCE ? 0 : 1;
            for (AchievementRewards::value_type const& v : m_achievementRewards)
                if (v.second.titleId[teamIndex] == title)
                    return v.first;
            return 0;
        }
