...
typedef std::map<uint32, CharTitlesEntry const*> TitleByIndexStore;
static TitleByIndexStore sTitleByIndexStore;
...
struct ResearchSiteEntry
{
    ...
    uint32 mapId;                                           // 1 map Id
    uint32 m_poi_id;                                        // 2 Point poi id
    char* name;                                             // 3 Site name
};

struct ResearchSitePoints
{
    uint32 id;
    int32 m_posX;                                           // 1 pos x
    int32 m_posY;                                           // 2 pos y
    uint32 m_poi_id;                                        // 3 Point poi id
};
...
struct ResearchProjectEntry
{
    ...
    uint32 quality;                                         // 3 0 common 1 > common
...
struct SkillLineAbilityEntry
{
    ...
    float     unk1;                                         // 5        m_excludeRace
    float     unk2;                                         // 6        m_excludeClass
