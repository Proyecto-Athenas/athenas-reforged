...
char const AchievementCriteriafmt[] = "niiiixiiiisiiiiixiiiiii";
const std::string CustomAchievementCriteriafmt = "pppppappppapppppapppppp";
...
char const CreatureModelDatafmt[] = "nisxfxxxxxxxxxxffxxxxxxxxxxxxxx";
char const CreatureFamilyfmt[] = "nfifiiiiixsx";
char const CreatureSpellDatafmt[] = "niiiixxxx";
char const CreatureTypefmt[] = "nxx";
char const CurrencyTypesfmt[] = "nixxxiiiiix";
char const DestructibleModelDatafmt[] = "niiiiiiiifiiiffiiifiiiii";
...
char const ResearchSitePointsfmt[]="niii";
...
char const SkillLineAbilityfmt[] = "niiiiffiiiiiii";
...
const std::string CustomWorldSafeLocsEntryfmt = "pppppp";
const std::string CustomWorldSafeLocsEntryIndex = "Id";
char const TransportAnimationEntryfmt[] = "diifffx";
char const TransportRotationEntryfmt[] = "diiffff";
