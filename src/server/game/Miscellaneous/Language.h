...
enum TrinityStrings
{
    ...
    LANG_COMMAND_QUEST_ADD_NO_LOOKUP      = 5500,
    LANG_COMMAND_QUEST_COMPLETE_NO_LOOKUP = 5501,
    LANG_COMMAND_QUEST_REWARDED_NO_LOOKUP = 5502,
    LANG_COMMAND_QUEST_IS_REPORTED        = 11999,
    ...
    LANG_BG_EYR_ALLY                     = 843,
    LANG_BG_EYR_HORDE                    ,
    LANG_BG_EYR_NODE_STABLES             ,
    LANG_BG_EYR_NODE_BLACKSMITH          ,
    LANG_BG_EYR_NODE_FARM                ,
    LANG_BG_EYR_NODE_LUMBER_MILL         ,
    LANG_BG_EYR_NODE_GOLD_MINE           ,
    LANG_BG_EYR_NODE_TAKEN               ,
    LANG_BG_EYR_NODE_DEFENDED            ,
    LANG_BG_EYR_NODE_ASSAULTED           ,
    LANG_BG_EYR_NODE_CLAIMED             ,
    LANG_BG_EYR_START_TWO_MINUTES        ,
    LANG_BG_EYR_START_ONE_MINUTE         ,
    LANG_BG_EYR_START_HALF_MINUTE        ,
    LANG_BG_EYR_HAS_BEGUN                ,
    LANG_BG_EYR_A_NEAR_VICTORY           ,
    LANG_BG_EYR_H_NEAR_VICTORY           ,
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_ACHIEVEMENT_EARNED             = 810, // unused
    ...
    LANG_ID_SWITCH_FAILED_NOT_MAP_RAID    = 11900,
    LANG_ID_SWITCH_FAILED_PROBLEM_UNKNOW  = 11901,
    LANG_ID_SWITCH_FAILED_NOT_SAME_ID     = 11902,
    LANG_ID_SWITCH_FAILED_NOT_SAME_MAP    = 11903,
