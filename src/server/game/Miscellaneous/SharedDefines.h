...
enum SpellAttr3
{
    ...
    SPELL_ATTR3_UNINTERRUPTIBLE                  = 0x00002000, // 13
    ...
    SPELL_ATTR7_CANT_MISS                        = 0x02000000, // 25 no cause spell pushback ?
...
enum SpellAttr5
{
    ...
    SPELL_ATTR5_CAN_NOT_TARGET_PETS              = 0x00000100, //  8
...
enum Targets
{
    ...
    TARGET_UNIT_TARGET_PASSENGER       = 95, // Related to vehicle passenger
    ...
    TARGET_UNIT_CONE_AREA_ENTRY_110    = 110, // 1 spell
    TARGET_UNK_111                     = 111,
    TARGET_UNK_112                     = 112,
    TARGET_UNK_113                     = 113,
    TARGET_UNK_114                     = 114,
    ...
    TARGET_UNK_124                     = 124,
    TARGET_UNK_125                     = 125,
    TARGET_UNIT_SRC_AREA_ENEMY_COUNT_TARGETS = 126, // currently only used on majordomos (firelands) fight... this target type should count the targets around the targets
    TARGET_UNK_127                     = 127,
    TOTAL_SPELL_TARGETS
};
...
enum BattlegroundTypeId
{
    ...
    BATTLEGROUND_EY_RATED       = 656, // Rated Eye of the Storm
...
enum BattlegroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_3v3_SOLO     = 13,
    BATTLEGROUND_QUEUE_1v1_SOLO     = 14,
    BATTLEGROUND_QUEUE_1v1_RATED    = 15,
    BATTLEGROUND_QUEUE_RBG_10_VS_10 = 16,
    BATTLEGROUND_QUEUE_RBG_15_VS_15 = 17,
    BATTLEGROUND_QUEUE_RBG_25_VS_25 = 18,
...
#define CURRENCY_WEEK_CAP_VALOR_POINTS 100000
