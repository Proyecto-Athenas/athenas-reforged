...
class BfCapturePoint
{
    public:
        ...
        void ResetCapturePointData(GameObject* capturePoint, TeamId team);
...
class Battlefield : public ZoneScript
{
    ...
    public:
        ...
        bool IsPlayerInWar(Player *player);
        ...
        void DisbandBFGroup(TeamId TeamId);
        ...
        GameObject* SpawnGameObject(uint32 entry, float x, float y, float z, float o, uint32 mapID);
        ...
        void AskToLeaveBattle(Player* player);
        ...
        bool CanQueue() { return m_Timer <= m_StartGroupingTimer; }

        void TeleportNonValidPlayers();
    ...
    protected:
        ...
        WorldLocation KickPositionA;                             // Position where players are teleported if they switch to afk during the battle or if they don't accept invitation
        WorldLocation KickPositionH;                             // Position where players are teleported if they switch to afk during the battle or if they don't accept invitation
