...
enum WorldBoolConfigs
{
    ...
    CONFIG_ARENA_SOLO_QUEUE_ENABLED,
    CONFIG_ARENA_SOLO_QUEUE_ENABLED_SKIRMISH,
    CONFIG_ARENA_SOLO_QUEUE_ENABLED_RATING,
    CONFIG_ARENA_SOLO_QUEUE_ENABLED_3v3,
    ...
    CONFIG_ASSIGN_MISSING_BROADCAST_AT_STARTUP,
    CONFIG_ELIGIBLE_CALL_TO_ARM_LFG,
    CONFIG_DISABLE_406_NERFS,
    CONFIG_DISABLE_420_NERFS,
    CONFIG_DISABLE_430_NERFS,
    CONFIG_OMFG_VERIFICATIONMGR_ENABLE,
    CONFIG_ENABLE_IP_HISTORY,
    CONFIG_RESET_ARENA_COOLDOWNS_AFTER_DUEL,
    CONFIG_BONUS_TIME_REWARD,
    CONFIG_TRANSMOG_ENABLE,
    CONFIG_TRANSMOG_TOKEN,
    CONFIG_TRANSMOG_MIXED_ARMOR,
    CONFIG_TRANSMOG_MIXED_WEAPON,
    CONFIG_TRANSMOG_MIXED_INVE,
    CONFIG_TRANSMOG_MIXED_CLASS,
    CONFIG_TRANSMOG_PLAYSOUND,
    CONFIG_ARENA_CUSTOM_REWARD,
    CONFIG_CHANGE_RACIAL,
...
enum WorldIntConfigs
{
    ...
    CONFIG_CURRENCY_CONQUEST_POINTS_SOLO_ARENA_REWARD,
    ...
    CONFIG_BATTLEGROUND_EXCEPTION_START,
    CONFIG_BATTLEGROUND_EXCEPTION_END,
    CONFIG_BATTLEGROUND_DECAY_TIMER,
    ...
    CONFIG_TOL_BARAD_RESTART_AFTER_CRASH,
    ...
    CONFIG_REPORTQUEST_UPDATETIMER,
    CONFIG_PLAYED_TIME_REWARD,
    CONFIG_TRANSMOG_GOLD,
    CONFIG_TRANSMOG_TOKEN_ID,
    CONFIG_TRANSMOG_TOKEN_AMOUNT,
    CONFIG_TRANSMOG_PLAYSOUND_ID,
    CONFIG_ARENA_CUSTOM_REWARD_ITEMID,
...
enum WorldStates
{
    ...
    WS_DAILY_ENDTIME_BOSSES = 20052,    // End time boss change
    WS_HALFUS_DRAGONS = 20070
};

enum ServerUpdateState
{
    SERVER_STATE_READY = 0,
    SERVER_STATE_COMPILING = 1,
    SERVER_STATE_RESTORING = 2,
    SERVER_STATE_COMPILE_ERR = 3,
    MAX_SERVER_STATE
};
...
public:
    ...
    void SendGlobalMessageLoc(int32 id);
    void SendBroadcastText(int32 string_id, int32 text);
    ...
    void SetForcedBG(BattlegroundTypeId bgtype)
    {
        forcedBG = bgtype;
    }

    BattlegroundTypeId GetForcedBG() { return forcedBG; }
    ...
    void SetServerUpdateState(uint8 state) { m_ServerUpdateState = state; }
    uint8 GetServerUpdateState() { return m_ServerUpdateState; }
    AutobroadcastLocale const *GetAutobroadcastLocales(int32 id) const
    {
        AutobroadcastsMap::const_iterator itr = m_Autobroadcasts.find(id);
        if (itr == m_Autobroadcasts.end())
            return NULL;
        return &itr->second;
    }
...
private:
    ...
    BattlegroundTypeId forcedBG;

    typedef std::map<uint8, AutobroadcastLocale> AutobroadcastsMap;
