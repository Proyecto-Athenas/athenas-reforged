...
enum SpellCustomAttributes
{
    ...
    SPELL_ATTR0_CU_PROC_ON_FULL_ABSORB           = 0x00040000,
    SPELL_ATTR0_CU_BINARY                        = 0x00080000,
...
public:
    ...
    inline bool HasAttribute(SpellAttr8 attribute) const { return (AttributesEx8 & attribute) != 0; }
    inline bool HasAttribute(SpellAttr9 attribute) const { return (AttributesEx9 & attribute) != 0; }
    inline bool HasAttribute(SpellAttr10 attribute) const { return (AttributesEx10 & attribute) != 0; }
    ...
    bool IsEffectAffectingOrTargetingArea(uint8 effectMask = MAX_EFFECT_MASK) const;
    bool IsAffectingArea(uint8 effectMask = MAX_EFFECT_MASK) const;
    bool IsTargetingArea(uint8 effectMask = MAX_EFFECT_MASK) const;
    bool NeedsExplicitUnitTarget() const;
    bool NeedsToBeTriggeredByCaster(uint8 effectMask = MAX_EFFECT_MASK) const;
    ...
    bool CanPierceImmuneAura(SpellInfo const* aura, const uint8 effectMask = MAX_EFFECT_MASK) const;
    ...
    int32 CalcPowerCost(Unit const* caster, SpellSchoolMask schoolMask, Spell* spell = NULL, bool baseCost = false) const;
    ...
    bool IsAutoshot() const { return Id == 75 || Id == 90916; }
