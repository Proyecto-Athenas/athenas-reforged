...
class Aura
{
    ...
    public:
        ...
        void SetLoadedState(int32 maxduration, int32 duration, int32 charges, uint32 stackamount, uint8 recalculateMask, int32 * amount);
        ...
        void CallScriptEffectUpdateHandlers(AuraEffect* aurEff, const uint32 diff);
