...
class Spell
{
    ...
    public:
        ...
        void cancel(Spell* interruptSpell = NULL);
        void update(uint32 difftime);
        void cast(bool skipCheck = false);
        void finish(bool ok = true, Spell* interruptSpell = NULL);
        void TakePower();
        ...
        SpellCastResult CheckBattlegroundCastRules();
    ...
    protected:
        ...
        std::map<Unit*, int> m_UniqueTargetInfoMap;
