...
class SpellScript : public _SpellScript
{
    ...
    public:
        ...
        void SetExplTargetUnit(Unit *target);
...
class AuraScript : public _SpellScript
{
    ...
    #define AURASCRIPT_FUNCTION_TYPE_DEFINES(CLASSNAME) \
        ...
        typedef void(CLASSNAME::*AuraEffectUpdateFnType)(AuraEffect*, const uint32 diff); \
        ...
        class EffectUpdateHandler : public EffectBase
        {
            public:
                ...
                void Call(AuraScript* auraScript, AuraEffect* aurEff, const uint32 diff);
            private:
    ...
    public:
        ...
        void SetStackAmount(uint32 num);
