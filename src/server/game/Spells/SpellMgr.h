...
enum ProcFlags
{
    ...
    PROC_FLAG_ON_CAST                         = 0x04000000,    // 26 Cast Spell
...
enum DurationIndex
{
    DURATION_1_SECONDS = 36,
    DURATION_2_SECONDS = 39,
    DURATION_3_SECONDS = 27,
    DURATION_4_SECONDS = 35,
    DURATION_5_SECONDS = 28,
    DURATION_6_SECONDS = 32,
    DURATION_8_SECONDS = 31,
    DURATION_9_SECONDS = 105,
    DURATION_10_SECONDS = 1,
    DURATION_11_SECONDS = 38,
    DURATION_12_SECONDS = 29,
    DURATION_15_SECONDS = 8,
    DURATION_18_SECONDS = 85,
    DURATION_20_SECONDS = 18,
    DURATION_21_SECONDS = 86,
    DURATION_24_SECONDS = 106,
    DURATION_25_SECONDS = 63,
    DURATION_30_SECONDS = 9,
    DURATION_40_SECONDS = 64,
    DURATION_45_SECONDS = 22,
    DURATION_53_SECONDS = 559,
    DURATION_60_SECONDS = 3,
    DURATION_75_SECONDS = 62,
    DURATION_90_SECONDS = 23,
    DURATION_120_SECONDS = 4,
    DURATION_160_SECONDS = 24,
    DURATION_180_SECONDS = 25,
    DURATION_230_SECONDS = 16,
    DURATION_240_SECONDS = 26,
    DURATION_300_SECONDS = 5,
    DURATION_360_SECONDS = 41,
    DURATION_600_SECONDS = 6,
    DURATION_1200_SECONDS = 40,
    DURATION_1800_SECONDS = 30,
    DURATION_3600_SECONDS = 42,
    DURATION_5000_SECONDS = 7,
...
class SpellMgr
{
    ...
    public:
        ...
        void LoadSpellNerfCorrections();
        void LoadBwDTfWBoTNerfCorrection(SpellInfo *spellInfo);
        void LoadFirelandsNerfCorrection(SpellInfo *spellInfo);
        void LoadDragonSoulNerfCorrection(SpellInfo *spellInfo);
        void LoadSpellCategoryCooldown(uint32 spellId, int32 cooldown, uint32 category, int32 categoryCooldown);
