    ...
    do
    {
        ...
        switch (type)
        {
            ...
            case DISABLE_TYPE_HEIGHT_RELOCATION:
            {
                ...
                {
                    case MAP_COMMON:
                        TC_LOG_INFO("misc", "Height relocation disabled for world map %u.", entry);
                        break;
                    case MAP_INSTANCE:
                    case MAP_RAID:
                        TC_LOG_INFO("misc", "Height relocation disabled for instance map %u.", entry);
                        break;
                    case MAP_BATTLEGROUND:
                        TC_LOG_INFO("misc", "Height relocation disabled for battleground map %u.", entry);
                        break;
                    case MAP_ARENA:
                        TC_LOG_INFO("misc", "Height relocation disabled for arena map %u.", entry);
                        break;
                    default:
                        break;
                }
