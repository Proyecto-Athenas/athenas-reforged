...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_IGNORE_PATHFINDING = 0x00120000,
    CREATURE_FLAG_EXTRA_DUNGEON_BOSS = 0x10000000,      // creature is a dungeon boss (SET DYNAMICALLY, DO NOT ADD IN DB)
    CREATURE_FLAG_EXTRA_TRAINING_DUMMY = 0x20000000,    // creature is a training summy (SET DYNAMICALLY, DO NOT ADD IN DB)
    CREATURE_FLAG_EXTRA_DISABLE_POWER_REG = 0x40000000, // creature can't regenerate mana
    CREATURE_FLAG_EXTRA_KNOCK_BACK_IMMUNE = 0x80000000  // creature is immune to knock back effects
};
...
#define CREATURE_REGEN_INTERVAL 2000
#define CREATURE_REGEN_ENERGY_INTERVAL 100
...
public:
    ...
    bool isTrainingDummy() const { return GetCreatureTemplate()->flags_extra & CREATURE_FLAG_EXTRA_TRAINING_DUMMY; }
    ...
    bool IsImmunedToSpell(SpellInfo const *spellInfo, Unit *caster = NULL, const uint8 effectMask = MAX_EFFECT_MASK) override;
    ...
    bool SetHover(bool enable) override;
    ...
    Player *SelectNearestPlayer(float distance = 0, int32 aura = 0) const;
    ...
    void TalkWithDelay(uint32 Delay, int32 Id, uint64 WhisperGuid, ChatMsg msgType = CHAT_MSG_MONSTER_YELL);
...
protected:
    ...
    void UpdateMovementFlag(bool checkMap = false);
