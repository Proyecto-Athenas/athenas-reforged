...
enum GOState
{
    ...
    GO_STATE_TRANSPORT_ACTIVE   = 24,                       // move GAMEOBJECT_TYPE_TRANSPORT to his start position
    GO_STATE_TRANSPORT_READY    = 25                        // move GAMEOBJECT_TYPE_TRANSPORT to his pause position
};
