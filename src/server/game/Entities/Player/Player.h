...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        */
        ...
        void SetSelection(uint64 guid) { m_curSelection = guid; SetUInt64Value(UNIT_FIELD_TARGET, guid); m_arenaSpectatorFlags |= ASPEC_FLAG_TARGET; }
    ...
    public:
        ...
        void RemoveSoloRating() { if (_soloStats.rating >= 16) _soloStats.rating -= 16; }
        void LoadSoloRating();
        void SaveSoloRating();
