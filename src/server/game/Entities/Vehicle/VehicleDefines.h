...
{
    ~PassengerInfo() { delete ExitPosition; }

    uint64 Guid = 0;
    bool IsUnselectable = false;
    Position* ExitPosition = nullptr;
    ...
    void Reset()
    {
        ...
        delete ExitPosition;
        ExitPosition = nullptr;
    }

    void SetExitPosition(Position const& pos)
    {
        delete ExitPosition;
        ExitPosition = new Position(pos);
    }
};
