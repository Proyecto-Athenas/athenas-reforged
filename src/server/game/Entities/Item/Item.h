...
class Item : public Object
{
    public:
        ...
        bool CanBeTransmogrified(bool transmogrifyBonus = false) const;
        bool CanTransmogrify(bool transmogrifyBonus = false) const;
        static bool CanTransmogrifyItemWithItem(Item const* transmogrified, Item const* transmogrifier, bool transmogrifyBonus = false);
