...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void ChangeSpawnMode(uint8 difficulty);
        ...
        uint16 GetAreaId(float x, float y, float z, bool *isOutdoors = 0) const;
        ...
        uint32 GetAlivePlayerCountExceptGMs() const;
        ...
        TempSummon* SummonCreature(uint32 entry, Position const& pos, SummonPropertiesEntry const* properties = NULL, uint32 duration = 0, WorldObject* summoner = NULL, uint32 spellId = 0, uint32 vehId = 0);
