...
enum BattlegroundRandomRewards
{
    ...
    BG_REWARD_WINNER_RBG_CONQUEST   = 40000,
};
...
struct BattlegroundPlayerStats
{
    BattlegroundPlayerStats() : joined(false) { }
...
class Battleground
{
    public:
        ...
        void SetRatedBattleground(bool isRatedBattleground) { m_IsRatedBattleground = isRatedBattleground; }
        ...
        bool isRatedBattleground() const { return m_IsRatedBattleground; }
        bool isSoloQueueArena() const { return m_IsSoloQueueArena; }

        typedef std::map<uint64, BattlegroundPlayer> BattlegroundPlayerMap;
        BattlegroundPlayerMap const& GetPlayers() const { return m_Players; }
        uint32 GetPlayersSize() const { return m_Players.size(); }
        typedef std::map<uint64, BattlegroundPlayerStats> BattlegroundPlayerStatsMap;
        ...
        void RemovePlayerFromResurrectQueue(uint64 player_guid, bool isReapply = false);
        ...
        void CreditQuestOnTeam(uint32 CreatureID, uint32 TeamID);
        ...
        void EndSoloBattleground(uint32 winner);
        ...
        void AddRBGPlayer(uint64 guid, BattlegroundPlayerStats stats) { m_AllPlayers[guid] = stats; }
        void SetRBGdidntJoin(uint64 guid);
        float GetChanceAgainst(uint32 ownRating, uint32 opponentRating);
        int32 GetMatchmakerRatingMod(uint32 ownRating, uint32 opponentRating, bool won);
        int32  GetRatingMod(uint32 ownRating, uint32 opponentRating, bool won);
        uint32 GetBattlegroundRating(uint32 rating, int32 mod);
        ...
        void SetOneVsOneRated(bool val) { m_oneVsOneRated = val; }
    ...
    protected:
        ...
        // Player lists of all players in rated bg, even if left or didnt join
        BattlegroundPlayerStatsMap m_AllPlayers;
