...
enum BG_IC_NPCs
{
    ...
    BG_IC_NPC_TELEPORTER_TRIGGER_1,
    BG_IC_NPC_TELEPORTER_TRIGGER_2,
    BG_IC_NPC_TELEPORTER_TRIGGER_3,
    BG_IC_NPC_TELEPORTER_TRIGGER_4,
    BG_IC_NPC_TELEPORTER_TRIGGER_5,
    BG_IC_NPC_TELEPORTER_TRIGGER_6,
    BG_IC_NPC_TELEPORTER_TRIGGER_7,
    BG_IC_NPC_TELEPORTER_TRIGGER_8,
    BG_IC_NPC_TELEPORTER_TRIGGER_9,
    BG_IC_NPC_TELEPORTER_TRIGGER_10,
    BG_IC_NPC_TELEPORTER_TRIGGER_11,
    BG_IC_NPC_TELEPORTER_TRIGGER_12,
    BG_IC_NPC_TELEPORTER_TRIGGER_13,
    BG_IC_NPC_TELEPORTER_TRIGGER_14,
...
enum BG_IC_MaxSpawns
{
    ...
    MAX_NORMAL_NPCS_SPAWNS = BG_IC_NPC_TELEPORTER_TRIGGER_14+1,
...
const ICNpc BG_IC_NpcSpawnlocs[MAX_NORMAL_NPCS_SPAWNS]=
{
    ...
    {BG_IC_NPC_TELEPORTER_TRIGGER_1,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 392.4965f, -859.4583f, 48.99871f, 3.036873f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_2,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 313.2344f, -918.0452f, 48.85597f, 4.869469f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_3,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 279.8698f, -832.8073f, 51.55094f, 0.0f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_4,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 323.4965f, -883.8021f, 48.99959f, 1.466077f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_5,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 430.6007f, -857.0052f, 48.31177f, 0.1396263f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_6,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 325.9167f, -781.8993f, 49.00521f, 4.590216f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_7,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 326.2135f, -744.0243f, 49.43576f, 1.308997f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_8,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 1139.498f, -779.4739f, 48.73496f, 3.001966f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_9,  NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 1162.913f, -745.908f,  48.71506f, 0.1396263f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_10, NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 1234.304f, -688.2986f, 49.22296f, 4.677482f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_11, NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 1232.524f, -666.3246f, 48.13402f, 2.303835f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_12, NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 1233.106f, -838.316f,  48.99958f, 1.466077f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_13, NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 1232.387f, -861.0243f, 48.99959f, 3.560472f}, //
    {BG_IC_NPC_TELEPORTER_TRIGGER_14, NPC_TELEPORTER_TRIGGER, TEAM_NEUTRAL, 1296.526f, -766.1823f, 50.70293f, 3.089233f}, //
