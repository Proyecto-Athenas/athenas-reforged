...
enum BG_SA_Objects
{
    ...
    BG_SA_RIGHT_FLAG,
    BG_SA_LEFT_FLAG,
    BG_SA_BOMB_FIRST_STAGE,
    BG_SA_BOMB_SECOND_STAGE,
    BG_SA_BOMB_THIRD_STAGE,
    BG_SA_BOMB_LAST_STAGE,
    BG_SA_MAXOBJ = BG_SA_BOMB_FIRST_STAGE+68
};
...
class BattlegroundSA : public Battleground
{
    ...
    private:
        ...
        /// Send packet to player for update boats (client part)
        void SendTransportUpdate(Player* player);
