...
const uint32 BG_AV_CreatureInfo[AV_NPC_INFO_MAX][4] =
{
    ...
    { 13358, TEAM_ALLIANCE, 59, 60 }, //Stormpike Bowman //i think its 60, 61 and 69, 70.. but this is until now not possible TODO look if this is ok
    ...
    { 13359, TEAM_HORDE, 59, 60 }, //Frostwolf Bowman
...
const uint32 BG_AV_StaticCreatureInfo[51][4] =
{
    ...
    { 13816, TEAM_ALLIANCE, 61, 61 }, //Prospector Stonehewer
