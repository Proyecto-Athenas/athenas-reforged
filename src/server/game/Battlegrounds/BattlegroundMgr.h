...
class BattlegroundMgr
{
    ...
    public:
        ...
        void BuildBattlegroundStatusPacket(WorldPacket* data, Battleground* bg, Player* player, uint8 queueSlot, uint8 statusId, uint32 time1, uint32 time2, uint8 arenaType, bool battlegroundEnd = false);
        ...
        Battleground* CreateNewBattleground(BattlegroundTypeId bgTypeId, PvPDifficultyEntry const* bracketEntry, uint8 arenaType, bool isRated, BattlegroundTypeId bgTypeIdRandom = BATTLEGROUND_TYPE_NONE);
        ...
        BattlegroundTypeId GetRandomBG(BattlegroundTypeId id, BattlegroundTypeId currentRandomBg = BATTLEGROUND_TYPE_NONE);
