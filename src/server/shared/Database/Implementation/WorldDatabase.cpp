...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(WORLD_UPD_ARCHAEOLOGY_REASEARCHSITE_POSITION, "UPDATE research_sites SET position_x = ?, position_y = ?, position_z = ?, enable = ?, map = ? where entry = ?", CONNECTION_ASYNC);
