...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_UPD_ARCHAEOLOGY_REASEARCHSITE_POSITION,
    WORLD_UPD_ARCHAEOLOGY_REASEARCHSITE_SKILL_REQ,
    WORLD_UPD_ARCHAEOLOGY_DISABLE_RESEARCH_SITE,
    WORLD_UPD_REPORT_QUESTS,
