...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_CHARACTER_LFRLOOTDATA,
    ...
    CHAR_DEL_GUILD_BANK_RIGHTS_FOR_RANK_UPD,
    ...
    CHAR_INS_CHARACTER_LFRLOOTDATA,
    CHAR_DEL_CHARACTER_LFRLOOTDATA,
    CHAR_DEL_CHARACTER_LFRLOOTDATA_BY_ENTRY,
    CHAR_DEL_ALL_CHARACTER_LFRLOOTDATA,
    ...
    CHAR_UPD_PLAYER_CURRENCY_NEW_CAP_OVERALL,
    CHAR_UPD_PLAYER_CURRENCY_NEW_CAP_ARENA,
    CHAR_UPD_PLAYER_CURRENCY_NEW_CAP_RBG,
    ...
    CHAR_UPD_RAID_DIFFICULTY,
    CHAR_UPD_RAID_DIFFICULTY_BY_GROUP,
    ...
    CHAR_UPD_CHAR_RESEARCH_HISTORY,

    CHAR_SEL_MAILS,
    CHAR_SEL_MAILS_ITEMS,

    CHAR_SEL_CHARACTER_GUILD_LEVEL,
    CHAR_UPD_GUILD_NAME,
